...
Feature: Verify Ferpa controls WRT groups
	...
	And the following "course enrolments" exist:
		...
		|s1|C1|student|
		|s4|C1|student|
		|t2|C1|editingteacher|
		|s2|C1|student|
		|t3|C1|editingteacher|
		|s3|C1|student|
		|t5|C1|editingteacher|
		|s5|C1|student|
	...
	Scenario: 1
		...
		Then I should not see "t2 Teacher (group2)" in the "#from_users" "css_element"
		Then I should not see "s2 Student (group2)" in the "#from_users" "css_element"
		Then I should not see "t3 Teacher (group3)" in the "#from_users" "css_element"
		Then I should not see "s3 Student (group3)" in the "#from_users" "css_element"
		Then I should not see "t5 Teacher (Not in a group)" in the "#from_users" "css_element"
		Then I should not see "s5 Student (Not in a group)" in the "#from_users" "css_element"
		And I log out
		...
		Then I should not see "t1 Teacher (group1)" in the "#from_users" "css_element"
		Then I should not see "s1 Student (group1)" in the "#from_users" "css_element"
		Then I should not see "t3 Teacher (group3)" in the "#from_users" "css_element"
		Then I should not see "s3 Student (group3)" in the "#from_users" "css_element"
		Then I should not see "t5 Teacher (Not in a group)" in the "#from_users" "css_element"
		Then I should not see "s5 Student (Not in a group)" in the "#from_users" "css_element"
		...
		Then I should not see "t1 Teacher (group1)" in the "#from_users" "css_element"
		Then I should not see "s1 Student (group1)" in the "#from_users" "css_element"
		Then I should not see "s4 Student (group1,group2)" in the "#from_users" "css_element"
		Then I should not see "t2 Teacher (group2)" in the "#from_users" "css_element"
		Then I should not see "s2 Student (group2)" in the "#from_users" "css_element"
		Then I should not see "t5 Teacher (Not in a group)" in the "#from_users" "css_element"
		Then I should not see "s5 Student (Not in a group)" in the "#from_users" "css_element"
		...
		Then I should not see "t1 Teacher (group1)" in the "#from_users" "css_element"
		Then I should not see "t4 Teacher (group1,group2,group3)" in the "#from_users" "css_element"
		Then I should not see "s1 Student (group1)" in the "#from_users" "css_element"
		Then I should not see "s4 Student (group1,group2)" in the "#from_users" "css_element"
		Then I should not see "t2 Teacher (group2)" in the "#from_users" "css_element"
		Then I should not see "s2 Student (group2)" in the "#from_users" "css_element"
