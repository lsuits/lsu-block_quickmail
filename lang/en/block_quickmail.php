...
$string['mentor_profile_key'] = 'Mentor Custom Profile Field Key';
$string['mentor_profile_key_desc'] = 'Custom User Profile Fields prepended with this key will get sent mentor emails for the given user.';
