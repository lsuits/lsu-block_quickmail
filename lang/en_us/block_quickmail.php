...
$string['guardianemail'] = 'Allows emails to also be sent to guardian(s)';
$string['guardianemail_desc'] = 'If this option is enabled quickmail emails will also be sent to guardians. Quickmail will get guardian emails from custom fields on a user profile with the shortname guardianemailone or guardianemailtwo or guardianemailthree.';
